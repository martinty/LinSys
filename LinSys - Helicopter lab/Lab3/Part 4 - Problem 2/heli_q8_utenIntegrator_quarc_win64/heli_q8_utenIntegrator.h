 ...
 */
#ifndef RTW_HEADER_heli_q8_utenIntegrator_h_
#define RTW_HEADER_heli_q8_utenIntegrator_h_
#include <string.h>
#ifndef heli_q8_utenIntegrator_COMMON_INCLUDES_
# define heli_q8_utenIntegrator_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_utenIntegrator_COMMON_INCLUDES_ */

#include "heli_q8_utenIntegrator_types.h"
...
#define heli_q8_utenIntegrator_rtModel RT_MODEL_heli_q8_utenIntegrat_T
...
typedef struct {
  ...
  real_T Gain8[6];                     /* '<Root>/Gain8' */
  real_T Sum2[6];                      /* '<S3>/Sum2' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } TravelrateTravelrate_PWORK;        /* '<S8>/Travel rate - Travel rate^' */

  struct {
    void *LoggedData;
  } PitchratePitchrate_PWORK;          /* '<S8>/Pitch rate - Pitch rate^' */

  struct {
    void *LoggedData;
  } ElevationrateElevationrate_PWOR;   /* '<S8>/Elevation rate - Elevation rate^' */
...
#define rtB                            heli_q8_utenIntegrator_B
#define BlockIO                        B_heli_q8_utenIntegrator_T
#define rtX                            heli_q8_utenIntegrator_X
#define ContinuousStates               X_heli_q8_utenIntegrator_T
#define rtXdot                         heli_q8_utenIntegrator_XDot
#define StateDerivatives               XDot_heli_q8_utenIntegrator_T
#define tXdis                          heli_q8_utenIntegrator_XDis
#define StateDisabled                  XDis_heli_q8_utenIntegrator_T
#define rtP                            heli_q8_utenIntegrator_P
#define Parameters                     P_heli_q8_utenIntegrator_T
#define rtDWork                        heli_q8_utenIntegrator_DW
#define D_Work                         DW_heli_q8_utenIntegrator_T

/* Parameters (auto storage) */
struct P_heli_q8_utenIntegrator_T_ {
...
struct tag_RTM_heli_q8_utenIntegrato_T {
  const char_T *path;
...
extern P_heli_q8_utenIntegrator_T heli_q8_utenIntegrator_P;

/* Block signals (auto storage) */
extern B_heli_q8_utenIntegrator_T heli_q8_utenIntegrator_B;

/* Continuous states (auto storage) */
extern X_heli_q8_utenIntegrator_T heli_q8_utenIntegrator_X;

/* Block states (auto storage) */
extern DW_heli_q8_utenIntegrator_T heli_q8_utenIntegrator_DW;
...
extern void heli_q8_utenIntegrator_initialize(void);
extern void heli_q8_utenIntegrator_output0(void);
extern void heli_q8_utenIntegrator_update0(void);
extern void heli_q8_utenIntegrator_output(int_T tid);
extern void heli_q8_utenIntegrator_update(int_T tid);
extern void heli_q8_utenIntegrator_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_utenIntegrat_T *const heli_q8_utenIntegrator_M;
 ...
 *
 * '<Root>' : 'heli_q8_utenIntegrator'
 * '<S1>'   : 'heli_q8_utenIntegrator/Conversion'
 * '<S2>'   : 'heli_q8_utenIntegrator/Elevation controller1'
 * '<S3>'   : 'heli_q8_utenIntegrator/Estimator1'
 * '<S4>'   : 'heli_q8_utenIntegrator/Heli 3D'
 * '<S5>'   : 'heli_q8_utenIntegrator/Joystick'
 * '<S6>'   : 'heli_q8_utenIntegrator/LQR'
 * '<S7>'   : 'heli_q8_utenIntegrator/Elevation controller1/Elevation controller'
 * '<S8>'   : 'heli_q8_utenIntegrator/Estimator1/Plotting'
 * '<S9>'   : 'heli_q8_utenIntegrator/Heli 3D/Elevation rad to deg'
 * '<S10>'  : 'heli_q8_utenIntegrator/Heli 3D/Elevation rate rad to deg'
 * '<S11>'  : 'heli_q8_utenIntegrator/Heli 3D/Pitch rad to deg'
 * '<S12>'  : 'heli_q8_utenIntegrator/Heli 3D/Pitch rate rad to deg'
 * '<S13>'  : 'heli_q8_utenIntegrator/Heli 3D/Travel rad to deg'
 * '<S14>'  : 'heli_q8_utenIntegrator/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_utenIntegrator_h_ */
