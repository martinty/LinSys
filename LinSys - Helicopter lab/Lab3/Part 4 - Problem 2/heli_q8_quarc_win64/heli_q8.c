 ...
 * C source code generated on : Tue Oct 25 07:13:12 2016
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      unnamed_idx_0 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_End;
    } else if (heli_q8_B.RateTransitionx >= heli_q8_P.DeadZonex_Start) {
      unnamed_idx_0 = 0.0;
    } else {
      unnamed_idx_0 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S5>/Gain: x'
     */
    heli_q8_B.Joystick_gain_x = heli_q8_P.Gainx_Gain * unnamed_idx_0 *
    ...
    if (heli_q8_B.RateTransitiony > heli_q8_P.DeadZoney_End) {
      unnamed_idx_0 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_End;
    } else if (heli_q8_B.RateTransitiony >= heli_q8_P.DeadZoney_Start) {
      unnamed_idx_0 = 0.0;
    } else {
      unnamed_idx_0 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S5>/Gain: y'
     */
    heli_q8_B.Joystick_gain_y = heli_q8_P.Gainy_Gain * unnamed_idx_0 *
    ...
    heli_q8_B.Gain[0] += heli_q8_P.P_LQR[0] * heli_q8_B.Joystick_gain_x;
    heli_q8_B.Gain[0] += heli_q8_P.P_LQR[2] * heli_q8_B.Joystick_gain_y;
    heli_q8_B.Gain[1] = 0.0;
    heli_q8_B.Gain[1] += heli_q8_P.P_LQR[1] * heli_q8_B.Joystick_gain_x;
    heli_q8_B.Gain[1] += heli_q8_P.P_LQR[3] * heli_q8_B.Joystick_gain_y;
  }
  ...
  tmp[3] = heli_q8_X.Integrator_CSTATE_n;
  tmp[4] = heli_q8_B.Integrator[2] - heli_q8_X.Integrator1_CSTATE;
  ...
  for (i = 0; i < 2; i++) {
    unnamed_idx_0 = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      unnamed_idx_0 += heli_q8_P.K_LQR[(i_0 << 1) + i] * tmp[i_0];
    }

    rtb_Sum[i] = heli_q8_B.Gain[i] - unnamed_idx_0;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<S13>/Gain' */
    heli_q8_B.Gain_p = heli_q8_P.Gain_Gain * heli_q8_B.TravelCounttorad;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum1 = heli_q8_B.Gain_e + heli_q8_P.Constant1_Value;
  }
  ...
  /* Gain: '<Root>/Gain8' */
  heli_q8_B.Gain8[0] = heli_q8_P.DegToRad * heli_q8_B.Gain_p;
  heli_q8_B.Gain8[1] = heli_q8_P.DegToRad * heli_q8_B.Gain_d;
  heli_q8_B.Gain8[2] = heli_q8_P.DegToRad * heli_q8_B.Gain_i;
  heli_q8_B.Gain8[3] = heli_q8_P.DegToRad * heli_q8_B.Gain_b;
  heli_q8_B.Gain8[4] = heli_q8_P.DegToRad * heli_q8_B.Sum1;
  heli_q8_B.Gain8[5] = heli_q8_P.DegToRad * heli_q8_B.Gain_dg;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
  ...
  for (i = 0; i < 3; i++) {
    tmp_0[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_0[i] += heli_q8_P.C[3 * i_0 + i] * heli_q8_B.Integrator[i_0];
    }
  }
   ...
   *  Gain: '<S3>/Gain4'
   */
  unnamed_idx_0 = heli_q8_B.Gain8[2] - tmp_0[0];
  unnamed_idx_1 = heli_q8_B.Gain8[4] - tmp_0[1];
  unnamed_idx_2 = heli_q8_B.Gain8[0] - tmp_0[2];
  for (i = 0; i < 6; i++) {
    /* Gain: '<S3>/Gain1' incorporates:
     *  Sum: '<S3>/Sum2'
     */
    tmp_1[i] = heli_q8_P.B[i + 6] * rtb_Sum[1] + heli_q8_P.B[i] * rtb_Sum[0];

    /* Gain: '<S3>/Gain4' incorporates:
     *  Sum: '<S3>/Sum2'
     */
    tmp_2[i] = heli_q8_P.L[i + 12] * unnamed_idx_2 + (heli_q8_P.L[i + 6] *
      unnamed_idx_1 + heli_q8_P.L[i] * unnamed_idx_0);
  }
  ...
  for (i = 0; i < 6; i++) {
    unnamed_idx_0 = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      unnamed_idx_0 += heli_q8_P.A[6 * i_0 + i] * heli_q8_B.Integrator[i_0];
    }

    heli_q8_B.Sum2[i] = (tmp_1[i] + tmp_2[i]) + unnamed_idx_0;
  }
   ...
   *  Sum: '<S1>/Add'
   */
  unnamed_idx_0 = (rtb_Sum[1] + rtb_Sum[0]) * heli_q8_P.Frontgain_Gain;

  /* Saturate: '<S4>/Front motor: Saturation' */
  if (unnamed_idx_0 > heli_q8_P.FrontmotorSaturation_UpperSat) {
    heli_q8_B.FrontmotorSaturation = heli_q8_P.FrontmotorSaturation_UpperSat;
  } else if (unnamed_idx_0 < heli_q8_P.FrontmotorSaturation_LowerSat) {
    heli_q8_B.FrontmotorSaturation = heli_q8_P.FrontmotorSaturation_LowerSat;
  } else {
    heli_q8_B.FrontmotorSaturation = unnamed_idx_0;
  }
   ...
   *  Sum: '<S1>/Subtract'
   */
  unnamed_idx_0 = (rtb_Sum[0] - rtb_Sum[1]) * heli_q8_P.Backgain_Gain;

  /* Saturate: '<S4>/Back motor: Saturation' */
  if (unnamed_idx_0 > heli_q8_P.BackmotorSaturation_UpperSat) {
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_UpperSat;
  } else if (unnamed_idx_0 < heli_q8_P.BackmotorSaturation_LowerSat) {
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_LowerSat;
  } else {
    heli_q8_B.BackmotorSaturation = unnamed_idx_0;
  }
  ...
  /* Sum: '<S6>/Sum1' */
  heli_q8_B.Sum1_h = heli_q8_B.Integrator[0] - heli_q8_B.Joystick_gain_x;
}
...
void heli_q8_derivatives(void)
{
  ...
  for (i = 0; i < 6; i++) {
    _rtXdot->Integrator_CSTATE[i] = heli_q8_B.Sum2[i];
  }

  /* End of Derivatives for Integrator: '<S3>/Integrator' */

  /* Derivatives for Integrator: '<S6>/Integrator' */
  _rtXdot->Integrator_CSTATE_n = heli_q8_B.Sum1_h;

  /* Derivatives for Integrator: '<S6>/Integrator1' */
  _rtXdot->Integrator1_CSTATE = heli_q8_B.Joystick_gain_y;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3469758301U);
  heli_q8_M->Sizes.checksums[1] = (1016158406U);
  heli_q8_M->Sizes.checksums[2] = (3931872077U);
  heli_q8_M->Sizes.checksums[3] = (2132259046U);
...

  {
    ...
    for (i = 0; i < 6; i++) {
      heli_q8_B.Gain8[i] = 0.0;
    }

    for (i = 0; i < 6; i++) {
      heli_q8_B.Sum2[i] = 0.0;
    }
  ...
  heli_q8_M->Sizes.numBlockPrms = (244);/* Sum of parameter "widths" */
  return heli_q8_M;
}
