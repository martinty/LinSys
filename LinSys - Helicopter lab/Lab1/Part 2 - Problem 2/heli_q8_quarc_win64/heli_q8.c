 ...
 * C source code generated on : Mon Oct 24 02:01:53 2016
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
   ...
   *  Gain: '<Root>/Gain8'
   */
  rtb_Sum_c = heli_q8_B.Constant2 - heli_q8_P.DegToRad * heli_q8_B.Sum1;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
   ...
   *  Sum: '<S7>/Sum'
   */
  rtb_Sum2 = ((heli_q8_P.K_ep_Gain * rtb_Sum_c + rtb_Sum2) - heli_q8_P.DegToRad *
              heli_q8_B.Gain_dg * heli_q8_P.K_ed_Gain) + heli_q8_B.Constant3;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<Root>/Gain1' */
    heli_q8_B.Gain1 = heli_q8_P.Gain1_Gain * heli_q8_B.Joystick_gain_x;
  }
   ...
   *  Sum: '<S5>/Sum'
   */
  rtb_Sum1 = (heli_q8_B.Gain1 - heli_q8_P.DegToRad * heli_q8_B.Gain_d) *
    heli_q8_P.k_rp;

  /* Saturate: '<Root>/Saturation' */
  if (rtb_Sum1 > heli_q8_P.Saturation_UpperSat) {
    rtb_Sum1 = heli_q8_P.Saturation_UpperSat;
  } else {
    if (rtb_Sum1 < heli_q8_P.Saturation_LowerSat) {
      rtb_Sum1 = heli_q8_P.Saturation_LowerSat;
    }
  }
   ...
   *  Sum: '<S6>/Sum'
   */
  rtb_Sum1 = (rtb_Sum1 - heli_q8_P.DegToRad * heli_q8_B.Gain_i) * heli_q8_P.k_pp
    - heli_q8_P.DegToRad * heli_q8_B.Gain_b * heli_q8_P.k_pd;
  ...
  /* Gain: '<S7>/K_ei' */
  heli_q8_B.K_ei = heli_q8_P.K_ei_Gain * rtb_Sum_c;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1287885145U);
  heli_q8_M->Sizes.checksums[1] = (3436702251U);
  heli_q8_M->Sizes.checksums[2] = (1779530025U);
  heli_q8_M->Sizes.checksums[3] = (4239837518U);
