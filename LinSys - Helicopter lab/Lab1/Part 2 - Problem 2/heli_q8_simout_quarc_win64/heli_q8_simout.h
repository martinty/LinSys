 ...
 */
#ifndef RTW_HEADER_heli_q8_simout_h_
#define RTW_HEADER_heli_q8_simout_h_
#include <string.h>
#ifndef heli_q8_simout_COMMON_INCLUDES_
# define heli_q8_simout_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_simout_COMMON_INCLUDES_ */

#include "heli_q8_simout_types.h"
...
#define heli_q8_simout_rtModel         RT_MODEL_heli_q8_simout_T
...
#define rtB                            heli_q8_simout_B
#define BlockIO                        B_heli_q8_simout_T
#define rtX                            heli_q8_simout_X
#define ContinuousStates               X_heli_q8_simout_T
#define rtXdot                         heli_q8_simout_XDot
#define StateDerivatives               XDot_heli_q8_simout_T
#define tXdis                          heli_q8_simout_XDis
#define StateDisabled                  XDis_heli_q8_simout_T
#define rtP                            heli_q8_simout_P
#define Parameters                     P_heli_q8_simout_T
#define rtDWork                        heli_q8_simout_DW
#define D_Work                         DW_heli_q8_simout_T

/* Parameters (auto storage) */
struct P_heli_q8_simout_T_ {
  ...
  real_T HILInitialize_set_other_outpu_l;/* Mask Parameter: HILInitialize_set_other_outpu_l
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize_set_other_outp_mp;/* Mask Parameter: HILInitialize_set_other_outp_mp
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  ...
  boolean_T HILInitialize_set_encoder_par_m;/* Mask Parameter: HILInitialize_set_encoder_par_m
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_other_outpu_p;/* Mask Parameter: HILInitialize_set_other_outpu_p
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  real_T Step1_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step1'
                                        */
  real_T Step1_YFinal;                 /* Expression: -2
                                        * Referenced by: '<Root>/Step1'
                                        */
  ...
  real_T ElevationTransferFcn_D;       /* Computed Parameter: ElevationTransferFcn_D
                                        * Referenced by: '<S3>/Elevation: Transfer Fcn'
                                        */
  real_T Gain_Gain_nr;                 /* Expression: 180/pi
...
struct tag_RTM_heli_q8_simout_T {
  const char_T *path;
...
extern P_heli_q8_simout_T heli_q8_simout_P;

/* Block signals (auto storage) */
extern B_heli_q8_simout_T heli_q8_simout_B;

/* Continuous states (auto storage) */
extern X_heli_q8_simout_T heli_q8_simout_X;

/* Block states (auto storage) */
extern DW_heli_q8_simout_T heli_q8_simout_DW;
...
extern void heli_q8_simout_initialize(void);
extern void heli_q8_simout_output0(void);
extern void heli_q8_simout_update0(void);
extern void heli_q8_simout_output(int_T tid);
extern void heli_q8_simout_update(int_T tid);
extern void heli_q8_simout_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_simout_T *const heli_q8_simout_M;
 ...
 *
 * '<Root>' : 'heli_q8_simout'
 * '<S1>'   : 'heli_q8_simout/Conversion'
 * '<S2>'   : 'heli_q8_simout/Elevation controller1'
 * '<S3>'   : 'heli_q8_simout/Heli 3D'
 * '<S4>'   : 'heli_q8_simout/Joystick'
 * '<S5>'   : 'heli_q8_simout/P controller'
 * '<S6>'   : 'heli_q8_simout/Pitch controller'
 * '<S7>'   : 'heli_q8_simout/Elevation controller1/Elevation controller'
 * '<S8>'   : 'heli_q8_simout/Heli 3D/Elevation rad to deg'
 * '<S9>'   : 'heli_q8_simout/Heli 3D/Elevation rate rad to deg'
 * '<S10>'  : 'heli_q8_simout/Heli 3D/Pitch rad to deg'
 * '<S11>'  : 'heli_q8_simout/Heli 3D/Pitch rate rad to deg'
 * '<S12>'  : 'heli_q8_simout/Heli 3D/Travel rad to deg'
 * '<S13>'  : 'heli_q8_simout/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_simout_h_ */
