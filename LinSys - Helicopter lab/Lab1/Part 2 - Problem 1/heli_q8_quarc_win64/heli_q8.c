 ...
 * C source code generated on : Mon Oct 24 00:59:07 2016
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  rtb_Sum2 = 0.0;
  rtb_Sum2 += heli_q8_P.TravelTransferFcn_C * heli_q8_X.TravelTransferFcn_CSTATE;
  rtb_Sum2 += heli_q8_P.TravelTransferFcn_D * heli_q8_B.TravelCounttorad;

  /* Gain: '<S13>/Gain' */
  heli_q8_B.Gain_d = heli_q8_P.Gain_Gain_l * rtb_Sum2;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  ...
  rtb_Sum2 = 0.0;
  rtb_Sum2 += heli_q8_P.PitchTransferFcn_C * heli_q8_X.PitchTransferFcn_CSTATE;
  rtb_Sum2 += heli_q8_P.PitchTransferFcn_D * heli_q8_B.PitchCounttorad;

  /* Gain: '<S11>/Gain' */
  heli_q8_B.Gain_b = heli_q8_P.Gain_Gain_ae * rtb_Sum2;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  ...
  rtb_Sum2 = 0.0;
  rtb_Sum2 += heli_q8_P.ElevationTransferFcn_C *
    heli_q8_X.ElevationTransferFcn_CSTATE;
  rtb_Sum2 += heli_q8_P.ElevationTransferFcn_D * heli_q8_B.ElevationCounttorad;

  /* Gain: '<S9>/Gain' */
  heli_q8_B.Gain_dg = heli_q8_P.Gain_Gain_n * rtb_Sum2;

  /* Gain: '<Root>/Gain8' */
  heli_q8_B.Gain8[0] = heli_q8_P.DegToRad * heli_q8_B.Gain;
  ...
  rtb_Sum2 = heli_q8_X.Integrator_CSTATE;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  ...
  /* Sum: '<S2>/Sum' */
  rtb_Sum_p = heli_q8_B.Constant2 - heli_q8_B.Gain8[4];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Constant: '<Root>/Constant3' */
    heli_q8_B.Constant3 = -heli_q8_P.L_2 / heli_q8_P.L_3;
  }
   ...
   *  Sum: '<S7>/Sum'
   */
  rtb_Sum2 = ((heli_q8_P.K_ep_Gain * rtb_Sum_p + rtb_Sum2) - heli_q8_P.K_ed_Gain
              * heli_q8_B.Gain8[5]) + heli_q8_B.Constant3;

  /* Step: '<Root>/Step' */
  rtb_Sum1 = heli_q8_M->Timing.t[0];
  ...
  /* Step: '<Root>/Step' */
  if (rtb_Sum1 < heli_q8_P.Step_Time) {
   ...
   *  Sum: '<S6>/Sum'
   */
  rtb_Sum1 = ((tmp + rtb_Sum1) - heli_q8_B.Gain8[2]) * heli_q8_P.k_pp -
    heli_q8_P.k_pd * heli_q8_B.Gain8[3];

  /* Gain: '<S1>/Back gain' incorporates:
   *  Sum: '<S1>/Subtract'
   */
  heli_q8_B.Backgain = (rtb_Sum2 - rtb_Sum1) * heli_q8_P.Backgain_Gain;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  heli_q8_B.Frontgain = (rtb_Sum1 + rtb_Sum2) * heli_q8_P.Frontgain_Gain;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1470940355U);
  heli_q8_M->Sizes.checksums[1] = (42372373U);
  heli_q8_M->Sizes.checksums[2] = (809124352U);
  heli_q8_M->Sizes.checksums[3] = (1854373012U);
