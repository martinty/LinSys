 ...
 * C source code generated on : Thu Oct 20 09:40:54 2016
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum = heli_q8_B.Gain_i + heli_q8_P.Constant_Value;
     ...
     *  Sum: '<S1>/Subtract'
     */
    heli_q8_B.Backgain = (rtb_FrontmotorSaturation - heli_q8_B.Joystick_gain_x) *
      heli_q8_P.Backgain_Gain;

    /* Gain: '<S1>/Front gain' incorporates:
     *  Sum: '<S1>/Add'
     */
    heli_q8_B.Frontgain = (heli_q8_B.Joystick_gain_x + rtb_FrontmotorSaturation)
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.Frontgain > heli_q8_P.FrontmotorSaturation_UpperSat) {
      ...
      rtb_FrontmotorSaturation = heli_q8_B.Frontgain;
    }
    ...
    if (heli_q8_B.Backgain > heli_q8_P.BackmotorSaturation_UpperSat) {
      ...
      rtb_BackmotorSaturation = heli_q8_B.Backgain;
    }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1883700426U);
  heli_q8_M->Sizes.checksums[1] = (11291252U);
  heli_q8_M->Sizes.checksums[2] = (383644655U);
  heli_q8_M->Sizes.checksums[3] = (260481518U);
  ...
  heli_q8_M->Sizes.numBlockPrms = (144);/* Sum of parameter "widths" */
  return heli_q8_M;
}
