...
typedef struct {
  ...
  real_T Gain2[6];                     /* '<Root>/Gain2' */
  real_T Integrator_h;                 /* '<S2>/Integrator' */
  real_T Integrator2_b;                /* '<S2>/Integrator2' */
  real_T Integrator4_b;                /* '<S2>/Integrator4' */
  real_T Gain3[6];                     /* '<Root>/Gain3' */
...
typedef struct {
  ...
  real_T Integrator1_CSTATE_m;         /* '<S2>/Integrator1' */
  real_T Integrator2_CSTATE_l;         /* '<S2>/Integrator2' */
  real_T Integrator3_CSTATE_a;         /* '<S2>/Integrator3' */
  real_T Integrator4_CSTATE_g;         /* '<S2>/Integrator4' */
  real_T Integrator5_CSTATE_j;         /* '<S2>/Integrator5' */
...
typedef struct {
  ...
  boolean_T Integrator1_CSTATE_m;      /* '<S2>/Integrator1' */
  boolean_T Integrator2_CSTATE_l;      /* '<S2>/Integrator2' */
  boolean_T Integrator3_CSTATE_a;      /* '<S2>/Integrator3' */
  boolean_T Integrator4_CSTATE_g;      /* '<S2>/Integrator4' */
  boolean_T Integrator5_CSTATE_j;      /* '<S2>/Integrator5' */
...
struct P_heli_q8_T_ {
  real_T J_e;                          /* Variable: J_e
                                        * Referenced by: '<S1>/Gain3'
                                        */
  real_T J_lambda;                     /* Variable: J_lambda
  ...
  real_T L_3;                          /* Variable: L_3
                                        ...
                                        *   '<S2>/Constant'
                                        */
  real_T L_4;                          /* Variable: L_4
                                        * Referenced by: '<S1>/Gain4'
                                        */
  real_T RadToDeg;                     /* Variable: RadToDeg
                                        * Referenced by:
                                        *   '<Root>/Gain2'
                                        *   '<Root>/Gain3'
                                        */
  ...
  real_T Integrator2_IC_m;             /* Expression: 0
                                        ...
                                        */
  real_T Integrator3_IC_e;             /* Expression: 0
  ...
  real_T Gainy_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T Gain1_Gain;                   /* Expression: 6
