 ...
 * C source code generated on : Thu Oct 20 12:30:25 2016
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
   ...
   */
  heli_q8_B.Gain2[0] = heli_q8_P.RadToDeg * heli_q8_B.Integrator;
  heli_q8_B.Gain2[1] = heli_q8_P.RadToDeg * heli_q8_X.Integrator1_CSTATE;
  heli_q8_B.Gain2[2] = heli_q8_P.RadToDeg * heli_q8_B.Integrator2;
  heli_q8_B.Gain2[3] = heli_q8_P.RadToDeg * heli_q8_X.Integrator3_CSTATE;
  heli_q8_B.Gain2[4] = heli_q8_P.RadToDeg * heli_q8_B.Integrator4;
  heli_q8_B.Gain2[5] = heli_q8_P.RadToDeg * heli_q8_X.Integrator5_CSTATE;

  /* Integrator: '<S2>/Integrator' */
  heli_q8_B.Integrator_h = heli_q8_X.Integrator_CSTATE_d;

  /* Integrator: '<S2>/Integrator2' */
  heli_q8_B.Integrator2_b = heli_q8_X.Integrator2_CSTATE_l;

  /* Integrator: '<S2>/Integrator4' */
  heli_q8_B.Integrator4_b = heli_q8_X.Integrator4_CSTATE_g;
   ...
   */
  heli_q8_B.Gain3[0] = heli_q8_P.RadToDeg * heli_q8_B.Integrator_h;
  heli_q8_B.Gain3[1] = heli_q8_P.RadToDeg * heli_q8_X.Integrator1_CSTATE_m;
  heli_q8_B.Gain3[2] = heli_q8_P.RadToDeg * heli_q8_B.Integrator2_b;
  heli_q8_B.Gain3[3] = heli_q8_P.RadToDeg * heli_q8_X.Integrator3_CSTATE_a;
  heli_q8_B.Gain3[4] = heli_q8_P.RadToDeg * heli_q8_B.Integrator4_b;
  heli_q8_B.Gain3[5] = heli_q8_P.RadToDeg * heli_q8_X.Integrator5_CSTATE_j;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum1 = heli_q8_B.Gain + heli_q8_P.Constant1_Value;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<S1>/Gain' */
    heli_q8_B.Gain_o = heli_q8_P.L_1 / heli_q8_P.J_p * heli_q8_B.Joystick_gain_x;
    ...
    /* Gain: '<S1>/Gain1' */
    heli_q8_B.Gain1_d = heli_q8_P.L_3 * heli_q8_B.Gain1;
  }
   ...
   */
  heli_q8_B.Gain3_d = (cos(heli_q8_X.Integrator1_CSTATE) * heli_q8_B.Gain1_d +
                       heli_q8_P.L_2 * cos(heli_q8_X.Integrator3_CSTATE)) * (1.0
    / heli_q8_P.J_e);
   ...
   */
  heli_q8_B.Gain4 = cos(heli_q8_X.Integrator3_CSTATE) * heli_q8_B.Gain1 * sin
    (heli_q8_X.Integrator1_CSTATE) * (heli_q8_P.L_4 / heli_q8_P.J_lambda);
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S2>/Gain' */
    heli_q8_B.Gain_n = heli_q8_P.K_1 * heli_q8_B.Joystick_gain_x;
  }

  /* Gain: '<S2>/Gain2' incorporates:
   *  Integrator: '<S2>/Integrator1'
   */
  heli_q8_B.Gain2_n = heli_q8_P.K_3 * heli_q8_X.Integrator1_CSTATE_m;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S2>/Gain1' incorporates:
     *  Constant: '<S2>/Constant'
     *  Sum: '<S2>/Sum'
     */
    heli_q8_B.Gain1_p = (heli_q8_P.L_2 / heli_q8_P.L_3 + heli_q8_B.Gain1) *
      heli_q8_P.K_2;

    /* Gain: '<S3>/Back gain' incorporates:
     *  Sum: '<S3>/Subtract'
     */
    rtb_BackmotorSaturation = (heli_q8_B.Gain1 - heli_q8_B.Joystick_gain_x) *
      heli_q8_P.Backgain_Gain;

    /* Gain: '<S3>/Front gain' incorporates:
     *  Sum: '<S3>/Add'
     */
    rtb_FrontmotorSaturation = (heli_q8_B.Joystick_gain_x + heli_q8_B.Gain1) *
...
void heli_q8_derivatives(void)
{
  ...
  _rtXdot->Integrator4_CSTATE = heli_q8_B.Gain4;

  /* Derivatives for Integrator: '<S1>/Integrator5' */
  _rtXdot->Integrator5_CSTATE = heli_q8_B.Integrator4;

  /* Derivatives for Integrator: '<S2>/Integrator' */
  _rtXdot->Integrator_CSTATE_d = heli_q8_B.Gain_n;

  /* Derivatives for Integrator: '<S2>/Integrator1' */
  _rtXdot->Integrator1_CSTATE_m = heli_q8_B.Integrator_h;

  /* Derivatives for Integrator: '<S2>/Integrator2' */
  _rtXdot->Integrator2_CSTATE_l = heli_q8_B.Gain1_p;

  /* Derivatives for Integrator: '<S2>/Integrator3' */
  _rtXdot->Integrator3_CSTATE_a = heli_q8_B.Integrator2_b;

  /* Derivatives for Integrator: '<S2>/Integrator4' */
  _rtXdot->Integrator4_CSTATE_g = heli_q8_B.Gain2_n;

  /* Derivatives for Integrator: '<S2>/Integrator5' */
  _rtXdot->Integrator5_CSTATE_j = heli_q8_B.Integrator4_b;
...
void heli_q8_initialize(void)
{
  ...
  heli_q8_X.Integrator_CSTATE_d = heli_q8_P.Integrator_IC_h;

  /* InitializeConditions for Integrator: '<S2>/Integrator1' */
  heli_q8_X.Integrator1_CSTATE_m = heli_q8_P.Integrator1_IC_k;

  /* InitializeConditions for Integrator: '<S2>/Integrator2' */
  heli_q8_X.Integrator2_CSTATE_l = heli_q8_P.Integrator2_IC_m;

  /* InitializeConditions for Integrator: '<S2>/Integrator3' */
  heli_q8_X.Integrator3_CSTATE_a = heli_q8_P.Integrator3_IC_e;

  /* InitializeConditions for Integrator: '<S2>/Integrator4' */
  heli_q8_X.Integrator4_CSTATE_g = heli_q8_P.Integrator4_IC_k;

  /* InitializeConditions for Integrator: '<S2>/Integrator5' */
  heli_q8_X.Integrator5_CSTATE_j = heli_q8_P.Integrator5_IC_i;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3015583769U);
  heli_q8_M->Sizes.checksums[1] = (2585045556U);
  heli_q8_M->Sizes.checksums[2] = (3167316295U);
  heli_q8_M->Sizes.checksums[3] = (2867818066U);
...

  {
    ...
    for (i = 0; i < 6; i++) {
      heli_q8_B.Gain3[i] = 0.0;
    }

    heli_q8_B.Integrator = 0.0;
    heli_q8_B.Integrator2 = 0.0;
    heli_q8_B.Integrator4 = 0.0;
    heli_q8_B.Integrator_h = 0.0;
    heli_q8_B.Integrator2_b = 0.0;
    heli_q8_B.Integrator4_b = 0.0;
    ...
    heli_q8_B.Gain3_d = 0.0;
    heli_q8_B.Gain4 = 0.0;
    heli_q8_B.Gain_n = 0.0;
    heli_q8_B.Gain2_n = 0.0;
    heli_q8_B.Gain1_p = 0.0;
  ...
  /* Initialize Sizes */
  heli_q8_M->Sizes.numContStates = (15);/* Number of continuous states */
