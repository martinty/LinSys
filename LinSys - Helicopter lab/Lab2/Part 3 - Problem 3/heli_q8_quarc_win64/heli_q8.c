 ...
 * C source code generated on : Tue Oct 25 05:16:13 2016
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
   ...
   *  Sum: '<S5>/Sum2'
   */
  rtb_Gain8_0[0] = rtb_Gain8_idx_2;
  rtb_Gain8_0[1] = heli_q8_P.DegToRad * heli_q8_B.Gain_b;
  rtb_Gain8_0[2] = heli_q8_P.DegToRad * heli_q8_B.Gain_dg;
  rtb_Gain8_0[3] = heli_q8_X.Integrator_CSTATE;
  rtb_Gain8_0[4] = heli_q8_P.DegToRad * heli_q8_B.Sum1 -
  ...
  for (i = 0; i < 2; i++) {
    tmp = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp += heli_q8_P.K[(i_0 << 1) + i] * rtb_Gain8_0[i_0];
    }

    heli_q8_B.Sum[i] = heli_q8_B.Gain[i] - tmp;
  }
   ...
   *  Sum: '<S1>/Subtract'
   */
  heli_q8_B.Backgain = (heli_q8_B.Sum[0] - heli_q8_B.Sum[1]) *
   ...
   *  Sum: '<S1>/Add'
   */
  heli_q8_B.Frontgain = (heli_q8_B.Sum[1] + heli_q8_B.Sum[0]) *
  ...
  /* Sum: '<S5>/Sum1' */
  heli_q8_B.Sum1_h = rtb_Gain8_idx_2 - heli_q8_B.Joystick_gain_x;
}
...
void heli_q8_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE = heli_q8_B.Sum1_h;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (827566888U);
  heli_q8_M->Sizes.checksums[1] = (1851078334U);
  heli_q8_M->Sizes.checksums[2] = (1050195315U);
  heli_q8_M->Sizes.checksums[3] = (3305614733U);
