 ...
 * C source code generated on : Tue Oct 25 05:13:33 2016
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      rtb_Gain8_idx_2 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_End;
    } else if (heli_q8_B.RateTransitionx >= heli_q8_P.DeadZonex_Start) {
      rtb_Gain8_idx_2 = 0.0;
    } else {
      rtb_Gain8_idx_2 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S4>/Gain: x'
     */
    heli_q8_B.Joystick_gain_x = heli_q8_P.Gainx_Gain * rtb_Gain8_idx_2 *
    ...
    if (heli_q8_B.RateTransitiony > heli_q8_P.DeadZoney_End) {
      rtb_Gain8_idx_2 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_End;
    } else if (heli_q8_B.RateTransitiony >= heli_q8_P.DeadZoney_Start) {
      rtb_Gain8_idx_2 = 0.0;
    } else {
      rtb_Gain8_idx_2 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S4>/Gain: y'
     */
    heli_q8_B.Joystick_gain_y = heli_q8_P.Gainy_Gain * rtb_Gain8_idx_2 *
    ...
    heli_q8_B.Gain[0] += heli_q8_P.P[0] * heli_q8_B.Joystick_gain_x;
    heli_q8_B.Gain[0] += heli_q8_P.P[2] * heli_q8_B.Joystick_gain_y;
    heli_q8_B.Gain[1] = 0.0;
    heli_q8_B.Gain[1] += heli_q8_P.P[1] * heli_q8_B.Joystick_gain_x;
    heli_q8_B.Gain[1] += heli_q8_P.P[3] * heli_q8_B.Joystick_gain_y;
  ...
  /* Gain: '<Root>/Gain8' */
  rtb_Gain8_idx_2 = heli_q8_P.DegToRad * heli_q8_B.Gain_i;
  rtb_Gain8_idx_3 = heli_q8_P.DegToRad * heli_q8_B.Gain_b;
  rtb_Gain8_idx_5 = heli_q8_P.DegToRad * heli_q8_B.Gain_dg;
   ...
   */
  for (i = 0; i < 2; i++) {
    rtb_Sum[i] = heli_q8_B.Gain[i] - ((heli_q8_P.K[i + 2] * rtb_Gain8_idx_3 +
      heli_q8_P.K[i] * rtb_Gain8_idx_2) + heli_q8_P.K[i + 4] * rtb_Gain8_idx_5);
  }
   ...
   *  Sum: '<S1>/Subtract'
   */
  heli_q8_B.Backgain = (rtb_Sum[0] - rtb_Sum[1]) * heli_q8_P.Backgain_Gain;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  heli_q8_B.Frontgain = (rtb_Sum[1] + rtb_Sum[0]) * heli_q8_P.Frontgain_Gain;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (617923726U);
  heli_q8_M->Sizes.checksums[1] = (847658035U);
  heli_q8_M->Sizes.checksums[2] = (4185759303U);
  heli_q8_M->Sizes.checksums[3] = (2602989537U);
