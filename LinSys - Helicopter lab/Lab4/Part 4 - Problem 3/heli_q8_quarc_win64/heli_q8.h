...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } PitchPitch_PWORK;                  /* '<S8>/Pitch - Pitch^' */

  struct {
    void *LoggedData;
  } Pitchrate1_PWORK;                  /* '<S8>/Pitch rate 1' */
  ...
  struct {
    void *LoggedData;
  } Elevationrate1_PWORK;              /* '<S8>/Elevation rate 1' */
 ...
 * '<S8>'   : 'heli_q8/Estimator/Plotting'
 * '<S9>'   : 'heli_q8/Heli 3D/Elevation rad to deg'
 * '<S10>'  : 'heli_q8/Heli 3D/Elevation rate rad to deg'
 * '<S11>'  : 'heli_q8/Heli 3D/Pitch rad to deg'
 * '<S12>'  : 'heli_q8/Heli 3D/Pitch rate rad to deg'
 * '<S13>'  : 'heli_q8/Heli 3D/Travel rad to deg'
 * '<S14>'  : 'heli_q8/Heli 3D/Travel rate  rad to deg'
 */
