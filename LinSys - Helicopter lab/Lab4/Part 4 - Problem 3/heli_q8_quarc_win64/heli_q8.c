...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  for (i = 0; i < 2; i++) {
    ...
    rtb_Sum3[i] = heli_q8_B.Gain[i] - unnamed_idx_0;
  }
  ...
  for (i = 0; i < 2; i++) {
    tmp_0[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_0[i] += heli_q8_P.C_1[(i_0 << 1) + i] * heli_q8_B.Integrator[i_0];
    }
  }
   ...
   *  Gain: '<S3>/Gain4'
   */
  unnamed_idx_0 = heli_q8_B.Gain8[4] - tmp_0[0];
  unnamed_idx_1 = heli_q8_B.Gain8[0] - tmp_0[1];
  for (i = 0; i < 6; i++) {
    /* Gain: '<S3>/Gain1' incorporates:
     *  Sum: '<S3>/Sum2'
     */
    tmp_1[i] = heli_q8_P.B[i + 6] * rtb_Sum3[1] + heli_q8_P.B[i] * rtb_Sum3[0];

    /* Gain: '<S3>/Gain4' incorporates:
     *  Sum: '<S3>/Sum2'
     */
    tmp_2[i] = heli_q8_P.L[i + 6] * unnamed_idx_1 + heli_q8_P.L[i] *
      unnamed_idx_0;
  }
   ...
   *  Sum: '<S1>/Add'
   */
  unnamed_idx_0 = (rtb_Sum3[1] + rtb_Sum3[0]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  unnamed_idx_0 = (rtb_Sum3[0] - rtb_Sum3[1]) * heli_q8_P.Backgain_Gain;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3069120786U);
  heli_q8_M->Sizes.checksums[1] = (1027065380U);
  heli_q8_M->Sizes.checksums[2] = (3248549317U);
  heli_q8_M->Sizes.checksums[3] = (1886011525U);
  ...
  heli_q8_M->Sizes.numBlocks = (64);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (23);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (232);/* Sum of parameter "widths" */
  return heli_q8_M;
}
